package com.biz.bizbulls.ui.registrationforfo.adapters
...
import com.biz.bizbulls.databinding.FoAdapterDashboardBinding
import com.biz.bizbulls.ui.registrationforfo.interfaces.IFoRegistrationStepsClickListener
...
class FoRegistrationDashboardAdapter(
    ...
    override fun onBindViewHolder(holder: FoRegistrationDashboardViewHolder, position: Int) {
       ...
       if (model.status!=0){
        ...
        holder.itemBinding.itemProgress.setBackgroundResource(com.biz.bizbulls.R.color.status_green)
    ...
    fun showPopupMenu(icnMenu: ImageView, model: Data, position: Int) {
        ...
        popup.getMenuInflater()
                .inflate(com.biz.bizbulls.R.menu.popup_menu, popup.getMenu())
