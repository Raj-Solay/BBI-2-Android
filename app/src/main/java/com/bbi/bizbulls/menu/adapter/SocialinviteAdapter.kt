...
class SocialinviteAdapter() :
    RecyclerView.Adapter<SocialinviteAdapter.ViewHolder>() {

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): SocialinviteAdapter.ViewHolder {
        val v =
            LayoutInflater.from(parent.context).inflate(R.layout.social_invite_adapter, parent, false)
        return ViewHolder(v)
    }
    override fun onBindViewHolder(holder: SocialinviteAdapter.ViewHolder, position: Int) {
